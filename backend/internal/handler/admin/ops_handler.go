...
type OpsHandler struct {
	...
	serverLoadService *service.ServerLoadService
}
...
func (h *OpsHandler) SetServerLoadService(serverLoadService *service.ServerLoadService) {
	if h == nil {
		return
	}
	h.serverLoadService = serverLoadService
}
